...
private:
	...
	// Convolution buffer
	int32_t Layer2_Input[26*26*32];
	int32_t Layer3_Input[12*12*16];
	int32_t Layer4_Input[10*10*8];
	int32_t Layer5_Input[4*4*3];
	int32_t Dense_Input[2*2*1];
	int32_t Output[10];
	...
	// Convolution iformations
	int _number_of_convs;
